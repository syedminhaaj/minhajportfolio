...
export class UserserviceService {
  ...
  {id:1,
    ...
    description:'Implemented new features for connectivity of devices using the micro front end architecture for devices and buildings, Where user can CRUD operations on the sites and devices page',
    summary:'Created dynamic reactive forms that are generated based on backend responses',
  ...
  {id:2,
    ...
    description:'Implemented new features in RTX DEX and upgraded to Angular material library removed ngPrime. Upated Angular version of the project from Angular 8 to Angular 14 by updating all dependencies.',
    summary:'Worked in a data exchange solution (RTS DEX) and new database (RTS Core)',
    tags:[TagDetails.ANGULAR,TagDetails.HTML,TagDetails.NODEJS],
    projectLinks:['https://www.halliburton.com/']

  },  {id:3,
    name:'Daintree DCS',
    description:'Developed an alerts feature for DCS, enabling user notifications via email and SMS when specific devices reach threshold values.Participated in code reviews, identified and resolved major issues, and optimized code for better performance and efficiency',
